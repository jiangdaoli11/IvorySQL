...
-- NULL input tests
SELECT INSTR(NULL, 'O') FROM DUAL;      -- Expected: NULL
SELECT INSTR('TEST', NULL) FROM DUAL;   -- Expected: NULL
SELECT INSTR(NULL, NULL) FROM DUAL;     -- Expected: NULL
...
-- TEXT
SELECT INSTR(CAST('OBJECT-ORIENTED PROGRAMMING' AS TEXT), CAST('O' AS TEXT)) FROM DUAL;
SELECT INSTR('OBJECT-ORIENTED PROGRAMMING'::TEXT, 'O') FROM DUAL;
